...
const BookingBox = () => {
  ...
  return (
    <Fragment>
      {boxShown ? (
        <div className="z-20 fixed left-0 top-0 sm:static flex w-full h-full items-center bg-black bg-opacity-50 sm:bg-transparent">
          <div className="flex w-full max-w-[450px] h-full max-h-full py-4 px-4 sm:py-6 sm:px-6 flex-col gap-4 overflow-y-auto bg-[#F1F6FE]">
